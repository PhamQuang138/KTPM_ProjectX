...
const dailyVehicles: DailyVehicle[] = [
  ...
  {make: 'Toyota', model: 'Yaris Cross', wikipediaPage: 'Toyota Yaris Cross', year: 2023, price: 650, bodyType: 'Crossover', fuelType: 'Hybrid', transmission: 'Automatic', mileage: 14000, specs: []},
  {make: 'Toyota', model: 'Wigo', wikipediaPage: 'Toyota Agya', year: 2023, price: 405, bodyType: 'Hatchback', fuelType: 'Gasoline', transmission: 'Automatic', mileage: 18000, specs: []},
  ...
  {make: 'Honda', model: 'Brio', wikipediaPage: 'Honda Brio', year: 2022, price: 418, bodyType: 'Hatchback', fuelType: 'Gasoline', transmission: 'Automatic', mileage: 22000, specs: []},
  {make: 'Honda', model: 'WR-V', wikipediaPage: 'Honda WR-V', year: 2023, price: 599, bodyType: 'Crossover', fuelType: 'Gasoline', transmission: 'Automatic', mileage: 12000, specs: []},
  ...
  {make: 'Mazda', model: 'Mazda2 Sport', wikipediaPage: 'Mazda2', year: 2022, price: 455, bodyType: 'Hatchback', fuelType: 'Gasoline', transmission: 'Automatic', mileage: 26000, specs: []},
  ...
  {make: 'Mazda', model: 'CX-30', wikipediaPage: 'Mazda CX-30', year: 2023, price: 699, bodyType: 'Crossover', fuelType: 'Gasoline', transmission: 'Automatic', mileage: 16000, specs: []},
  {make: 'Mazda', model: 'MX-5', wikipediaPage: 'Mazda MX-5', year: 2022, price: 1650, bodyType: 'Convertible', fuelType: 'Gasoline', transmission: 'Manual', mileage: 9000, specs: [], category: 'Exotics'},
  ...
  {make: 'Ford', model: 'Territory Trend', wikipediaPage: 'Ford Territory (China)', year: 2022, price: 699, bodyType: 'Crossover', fuelType: 'Gasoline', transmission: 'Automatic', mileage: 28000, specs: []},
  ...
  {make: 'Nissan', model: 'Kicks', wikipediaPage: 'Nissan Kicks', year: 2023, price: 789, bodyType: 'Crossover', fuelType: 'Hybrid', transmission: 'Automatic', mileage: 17000, specs: []},
  ...
  {make: 'Suzuki', model: 'Swift', wikipediaPage: 'Suzuki Swift', year: 2022, price: 560, bodyType: 'Hatchback', fuelType: 'Gasoline', transmission: 'Automatic', mileage: 21000, specs: []},
  ...
  {make: 'BMW', model: 'Z4', wikipediaPage: 'BMW Z4', year: 2024, price: 3299, bodyType: 'Convertible', fuelType: 'Gasoline', transmission: 'Automatic', mileage: 0, specs: [], category: 'Exotics'},
  ...
  {make: 'Mercedes-Benz', model: 'SL', wikipediaPage: 'Mercedes-Benz SL-Class', year: 2024, price: 6999, bodyType: 'Convertible', fuelType: 'Gasoline', transmission: 'Automatic', mileage: 0, specs: [], category: 'Exotics'},
  ...
  {make: 'Audi', model: 'A3 Sportback', wikipediaPage: 'Audi A3', year: 2024, price: 1699, bodyType: 'Hatchback', fuelType: 'Gasoline', transmission: 'Automatic', mileage: 0, specs: []},
  ...
  {make: 'Volkswagen', model: 'Polo', wikipediaPage: 'Volkswagen Polo', year: 2024, price: 799, bodyType: 'Hatchback', fuelType: 'Gasoline', transmission: 'Automatic', mileage: 0, specs: []},
  ...
  {make: 'Porsche', model: '718 Boxster', wikipediaPage: 'Porsche Boxster and Cayman', year: 2024, price: 4999, bodyType: 'Convertible', fuelType: 'Gasoline', transmission: 'Automatic', mileage: 0, specs: [], category: 'Exotics'},
...
const vehicleUseCases: Record<string, string> = {
  ...
  Convertible: 'nhấn mạnh cảm giác lái thoáng, dáng xe cá tính và trải nghiệm cuối tuần',
